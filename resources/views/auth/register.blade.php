            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Nom de l'agence" class="form-control" aria-describedby="textHelp" name="name">
                    </div>

                    <div class="form-group">
                        <label for="telephone" class="sr-only">Numero de Telephone</label>
                        <input type="text" placeholder="Numero de Telephone" class="form-control" aria-describedby="textHelp" name="telephone">
                    </div>

                    <div class="form-group">
                        <label for="adresse" class="sr-only">Adresse</label>
                        <input type="text" placeholder="Adresse" class="form-control" aria-describedby="textHelp" name="adresse">
                    </div>
            ...
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Nom du Laboratoire" class="form-control" aria-describedby="textHelp" name="name">
                    </div>
